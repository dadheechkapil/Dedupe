view: ccd_master_hashed_july2021 {
  sql_table_name: `mahindra-one-324708.ccd_dbo.ccd_master_hashed_july2021`
    ;;
  ...
  measure: Count_of_Clean_Primary_Mobile {
    type: count_distinct
    sql: ${clean_primary_mobile } ;;
  }
